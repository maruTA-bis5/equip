...
/**
 * Equip_AbstractAction
**/
abstract class Equip_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Equip_Module ***/ $mModule = null;

    public /*** Equip_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Equip_{Tablename}Handler
    **/
