...
/**
 * Equip_AbstractViewAction
**/
abstract class Equip_AbstractViewAction extends Equip_AbstractAction
{
	...
	**/
	...
	{
		$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_EQUIP_ERROR_CONTENT_IS_NOT_FOUND);
	}
}
