...
/**
 * Equip_AbstractListAction
**/
abstract class Equip_AbstractListAction extends Equip_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Equip_AbstractFilterForm ***/ $mFilter = null;
	 ...
	 * @param	void
	 * 
	 * @return	Equip_{Tablename}FilterForm
	**/
